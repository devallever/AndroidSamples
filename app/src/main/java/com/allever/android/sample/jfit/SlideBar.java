...
//    private OnTouchLetterChangeListenner onTouchUpListenner;
   ...
   /* public void setOnTouchUpListenner(OnTouchLetterChangeListenner onTouchLetterChangeListenner) {
        this.onTouchUpListenner = onTouchLetterChangeListenner;
    }*/
    ...
    protected void onDraw(Canvas canvas) {
      ...
      /*  paint.setColor(Color.rgb(25,60,76));
        canvas.drawRoundRect(new RectF(0, 0, getWidth(), getAge()),
                20, 20, paint);*/
        if (isTouch && chooseBackgroundColor != Color.TRANSPARENT && chooseStyle != STYLE.NONE) { //触摸时画出背景色
            ...
            } else if (chooseStyle == STYLE.RECT) {
        ...
        for (int i = 0; i < len; i++) {
            ...
            float w = paint.measureText(letters[i]);
            float x = width / 2;
            float y = singleHeight * (i + 1) - w / 2;
            //画字母
    ...
    public boolean dispatchTouchEvent(MotionEvent event) {
        ...
        Log.d("SlideBar", "event-action: " + event.getAction() + " , index: " + index);
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if (index >= 0 && index < letters.length) {
                    ...
                    if (onTouchLetterChangeListenner != null) {//监听回调
                        onTouchLetterChangeListenner.onTouchLetterChange(isTouch, null);
                    }
                }
