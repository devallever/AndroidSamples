...
public class NearbyNewsBaseAdapter extends RecyclerView.Adapter<NearbyNewsBaseAdapter.MyViewHolder> {
    private List<NearbyNewsItem> list_nearby_news_items;
    private Context context;

    public NearbyNewsBaseAdapter(Context context, List<NearbyNewsItem> list_newrby_news_items){
        this.context = context;
        this.list_nearby_news_items = list_newrby_news_items;
    }

    @Override
    public int getItemCount() {
        return list_nearby_news_items.size();
    }
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        NearbyNewsItem nearbyNewsItem = list_nearby_news_items.get(position);
